...
import { type ProjectSettingsTab, useUIStore } from "@/stores/ui-store";
...
export function ProjectSettingsDialog({
	...
	const isOpen = useUIStore((state) => state.isProjectSettingsOpen);
	const setOpen = useUIStore((state) => state.setProjectSettingsOpen);
	const closeProjectSettings = useUIStore(
		(state) => state.closeProjectSettings,
	);
	const activeTab = useUIStore((state) => state.projectSettingsTab);
	const setTab = useUIStore((state) => state.setProjectSettingsTab);
