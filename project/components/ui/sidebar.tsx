...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: <Biome does not support useEffect yet>
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: <Biome does not support useCallback yet>
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: <Biome does not support useMemo yet>
