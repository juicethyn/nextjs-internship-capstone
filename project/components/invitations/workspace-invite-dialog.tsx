...
import { findWorkspaceInviteeByEmailAction } from "@/lib/actions/workspaceInvitations";
...
export function WorkspaceInviteDialog({
	...
	const isOpen = useUIStore((state) => state.isWorkspaceInviteOpen);
	const setOpen = useUIStore((state) => state.setWorkspaceInviteOpen);
