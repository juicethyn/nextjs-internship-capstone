...
import { ProjectMemberRow } from "@/features/projects/components/settings/project-member-row";
import { useProjectMembers } from "@/features/projects/hooks/use-project-members";
import {
	getAvailableWorkspaceMembers,
	getProjectRoster,
} from "@/features/projects/lib/roster";
import { useProjectUIStore } from "@/features/projects/store";
import type { ProjectDetail } from "@/features/projects/types";
import { filterMembersBySearch, memberDisplayName } from "@/lib/user-display";
...
export function ProjectInviteDialog({
	...
	const isOpen = useProjectUIStore((state) => state.isProjectInviteOpen);
	const setOpen = useProjectUIStore((state) => state.setProjectInviteOpen);
