...
import type { CreatableListType } from "@/lib/db/types";
...
export function CreateListDialog({
	...
	const isCreateListOpen = useProjectUIStore((state) => state.isCreateListOpen);
	const setCreateListOpen = useProjectUIStore(
		(state) => state.setCreateListOpen,
	);
